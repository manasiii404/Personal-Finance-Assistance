  ...
  return (
    <div className="space-y-3">
      {transactions.map((transaction) => (
        <div key={transaction.id} className="flex items-center justify-between p-4 card-glass-blue hover:card-glass-purple transition-all duration-300">
          <div className="flex items-center space-x-3">
            <div className={`p-3 rounded-2xl backdrop-blur-sm border ${transaction.type === 'income'
